...
def prepare_environment():
    ...
    gfpgan_package = os.environ.get('GFPGAN_PACKAGE', " --trusted-host pypi.tuna.tsinghua.edu.cn GFPGAN ")
    clip_package = os.environ.get('CLIP_PACKAGE', " --trusted-host pypi.tuna.tsinghua.edu.cn clip")
    openclip_package = os.environ.get('OPENCLIP_PACKAGE', " --trusted-host pypi.tuna.tsinghua.edu.cn open_clip_torch")
